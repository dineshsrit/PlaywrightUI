...
export default defineConfig({
  testDir: './tests/regspecs',
  timeout:30000,

  //globalSetup:require.resolve('./globalcofig/globalsetup.spec.ts'),
  //globalTeardown:require.resolve('./globalcofig/globalteardown.spec.ts'),
  
 
  testIgnore:['tests/example.spec.ts','tests/test1.spec.ts'],
